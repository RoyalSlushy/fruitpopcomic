  ...
  entries: [
    {
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“I don’t want to be a hero, because heroes suffer and I’m scared.” — the fear underneath the whole of her early story.</p></blockquote>
...
<p>Ronnie’s powers come from eating a magical starfruit, one of the indestructible <strong>Power Fruits</strong>. The starfruit embodies <strong>Dreams and Aspirations</strong>, and it chose the person with more imagination than anyone else in Pittscoke. The energy manifests as light-based concussive blasts — force, not heat.</p>
<ul>
...
<li><strong>Eye colour.</strong> Written green, frequently drawn yellow — both are treated as canon.</li>
    ...
    },
    {
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“Look, we argue and disagree a lot, but if we can all agree that Liz is a bitch then we can agree on a plan.”</p></blockquote>
...
<li>Her original introduction fight against Captain McIntosh was cut — he now arrives much later as a looming threat.</li>
    ...
    },
    {
      ...
      published: true,
      body: `<blockquote><p>“Hear me, Pomens! Invaders who seek to shatter my golden age! STAND PROUD! For you have the privilege of falling before me and becoming yet another page in the tale of my supremacy!”</p></blockquote>
...
<li>Early notes gave her five siblings; the final family is eight children with Lulu third-youngest.</li>
    ...
    },
    {
      ...
      published: true,
      body: `<p><strong>Elizabeth “Liz” Prescott</strong> is the daughter of beverage magnate Sterling Prescott, raised in Pittscoke’s gated community on Mary Shelly Lane. She is the last of the original five to join, and the one who develops the most.</p>
...
<li>Old alias “Strawburst” was renamed <strong>Strawheart</strong> so the team’s names wouldn’t all rhyme.</li>
    ...
    },
    {
      ...
      published: true,
      body: `<blockquote><p>Her whole arc in one line: “Hey I’m an alien, you ate an experimental fruit and I’m 99% sure you’re going to explode, so I’ll hang around for research reasons” → “Oh my god, we destroy planets for no reason. I have to find a way to kill god.”</p></blockquote>
...
<p>She appears at Ronnie’s lowest point, indirectly re-lights her resolve, runs with the team for a while — then hears about the wars in space and simply leaves to fight them, vanishing from the story for volumes before returning unannounced for the final battle.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<blockquote><p>Lucky: “How isn’t it weird how—” Ronnie: “Dogs don’t talk.” “Well I do, and I—” “Nope, no— shut up.”</p></blockquote>
...
<h3>Role</h3>
<p>Lucky spent his life listening to Ronnie read bedtime stories about heroes to her siblings, so he sees her as one and cannot understand why she’s so conflicted about it. Through Chapter 2 he is the story’s conscience: a constant, sardonic reminder of the pumpkin fight she is pretending never happened, finally goading her into being proactive. He sometimes refuses to talk purely to mess with her — her punishment, the creators note, for giving Lucky the burden of sapience. Little Maeve knows he can talk; nobody believes her.</p>
...
<li>The café began as “Fruit Papa’s Smoothie Place” in early notes; the final canon is simply the O’Malley café and bakery.</li>
    ...
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Sterling Prescott</strong> heads Sterling Industries, the soda empire behind Fizz Deluxe and a rollout of new fruit flavours — one of which accidentally carries the super orange that empowers Baby. Outwardly calm, cool and collected, a little too much; inwardly a man whose affection for his own daughter tracks his company’s stock price.</p>
...
<h3>Character</h3>
<p>Not old money: a poor childhood taught him money solves everything, and he believes only in growth. His wife was his one source of ease, and she left shortly after Liz was born. With the company declining he was willing to commit treason — cutting a deal with the Pomens to restore his numbers. He is dangerous not through power but through <strong>trust and dependency</strong>: he publicly endorses his daughter’s team, then uses them as a tool of his empire, and the Pomens copy his playbook when brute force keeps failing. Thematically, he combats the story’s theme of everlasting love by manipulating the very idea of love.</p>

<h3>The Cherry</h3>
<p>Sterling shares the two-user Cherry with <strong>Red Delicious</strong> — a “tool of diplomacy” that supposedly leashes both parties equally. She let him clamp his chain on her wrist as a show of good faith; then she drove her chain into his chest, wrapped around his heart. He tells himself they are equals. They are not.</p>

<h3>Fate</h3>
<p>After Season 1 collapses around him he flees abroad into exile rather than prison — with a planned final send-off years later as a “rich local” judge at the international baking competition, where the last loose ends with Liz are tied off. (The exact shape of the exile arc is still being workshopped.)</p>`,
    },
    {
      id: 'wk-jackie',
...
<p>Through Ronnie’s eyes they first appear only as masked figures in hazmat suits, their sizes and voices exaggerated by her imagination. They stay masked until Qwiwi befriends her and brings her to the greenhouse — and then the whole team unmasks at once. In place of human swearing they use fruit idioms: “Dear Mother.” “Fruit bears many seeds.”</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“You will make three more,” — Ambrosia, on being told only two positronic brains remain in the cosmos.</p></blockquote>
...
<p>The ending is built in two movements. First the spiritual victory: while the team fights the Elites high in the Orchard’s rafters, Ronnie falls into the green mind-tanks, cuts through the cacophony of uploaded generals, and puts Mother to rest — collapsing the collective. Then the physical one: the Orchard crashes to Earth, and what remains of Ambrosia’s body — running on pure mechanical backup instructions, screaming static — must be destroyed in the ruins of Ranger Stadium, the whole team bracing Ronnie through one endless final beam.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Mother</strong> was the Pomen matriarch of an era so long gone that modern Pomens treat it as mythology — a time when the species was peaceful, prosperous, and still able to hold fruit power. Her story survives only orally, mixed with propaganda, told in fragments by keepers like Arkan Black: Mother, her low-born Lover who first held the Kiwi and saw too far, the famine his vision promised, the rationing, the resentment, the civil war — and finally the day her people decided her body could not be saved, but her mind was worth keeping.</p>

<h3>In the machine</h3>
<p>She was uploaded to add nuance to the new machine-ruler — she would have argued that the people, not the planet, were the true homeworld. But by then enough wartime generals and strategists had been uploaded alongside her that their voices drowned hers out. The creators’ metaphor: a singer with a microphone can sway a room — unless the room is full of microphones. What remains of her is an inconceivably small voice inside Ambrosia, waiting eons for someone to hear it.</p>

<h3>Design</h3>
<p>Drawn like a bride awaiting a groom who will never come, with the vague feeling of a 1930s actress. Her eyes are unlike any modern Pomen’s — quiet evidence of how far the species has devolved since her time. Her fruit is the <strong>Apple — Contentment and Prudence</strong> — the exact opposite of Ronnie’s Dreams and Aspirations: one strives for what could be, the other for what is and has been.</p>

<h3>The two expressions</h3>
<p>Mother is always seen with a faint smile, cold and warm at once. It changes exactly twice in the entire story: once when Qwiwi finds a way to escape the Orchard — and once at the very end, when she is dying and asks Ronnie not to leave her as eons run through her mind.</p>`,
    },
    {
      id: 'wk-cosmic',
      slug: 'cosmic',
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“It’s telling me to kill you, but I was gonna do that anyway.”</p></blockquote>
...
<p>His defining scene: watching Cosmic’s red trail pass his station toward Earth — no orders having come through him — and understanding that Ambrosia has broken her own protocols. When Envy hails him with her progress report, he declines the call without a word, choosing not to warn her that she has already been written off. It is the first time in his life he has felt uncertain, and the first time he realises something is wrong with Ambrosia in a way that cannot be fixed.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Captain McIntosh</strong> is the Season 1 mid-boss: huge, stern, honourable in his way, and the only captain without the fanaticism of his peers. He won his rank on pure physical prowess — the Jasper problem: unstoppable if he ever applied himself, which he doesn’t until it’s far too late for the Empire’s purposes. Qwiwi’s description: “if a big friendly man was unfriendly.”</p>
...
<p>He wanted to be the next Elden, Ambrosia’s number one — a dreamer biologically barred from the fruit power he craved, an astronaut who can’t pass the physical. Witnessing what the other captains’ campaigns actually look like turns his stomach; losing to Lulu finishes the job. At rock bottom he forsakes the name McIntosh out of shame and remakes himself as <strong>the Crimson Comet</strong>, named for the Empire’s own propaganda comic. The palette is an accident that became a signature: his battle-stained armour needed a white primer coat, the red paint ran out, and he looked so much like the comics that he leaned in. His loyal squad follows him; his heroic persona is, in the creators’ words, him selling himself to himself — and it works. He may eventually earn a Power Fruit of his own alongside Qwiwi, and stand as Earth’s representative to the wider galaxy.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“Don’t you remember? The crispness of that first bite?… Do you remember being happy? — Then you remember me.”</p></blockquote>
...
<h3>Dynamics</h3>
<p>Alone, Gala is the meaner and methodical one and Smith is quiet, by-the-book, and genuinely gifted at making fruit mutants — a savant. Together they enable each other into mayhem, the getting-drunk-with-friends effect in villain form. Their creations are dangerous; they mostly are not, and the story’s answer to them is never a final defeat — they always slip away like lucky, slimy rats — but a change of heart.</p>

<h3>The turn</h3>
<p>In the Season 1 finale, Smith is embedded with the science team building Red’s mind-control monster while Gala works inside Jackie’s station to send the activation broadcast — and Jackie flips them both with the observation that they’d have far more fun without being under Red’s boot. The signal dies, the plot collapses, and the Empire’s silliest captains defect over job satisfaction. In the epilogue era they make game shows with her.</p>`,
    },
    {
      id: 'wk-envy',
      slug: 'envy',
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“I don’t want to be this kind of animal anymore. I don’t want to think or feel. I just want to be happy.”</p></blockquote>
...
<p>Envy arrives on Earth mid-story, working her way north through the wooded backcountry — her approach to Pittscoke ends in the single most humiliating ambush in the Empire’s history, courtesy of the city’s sentient palm-tree defenders. As her hunts keep failing she declines the way an animal declines: worse and wilder, until Jonagold silently declines her final call, and she realises the Empire has already written her off — the moment before Cosmic arrives. Her planned last line, to whoever finally puts her down: <strong>“Welcome to the top of the food chain.”</strong></p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Jazz</strong> and <strong>Champlain</strong> are mid-story antagonists designed as a classic paired boss — the huge slow one and the fast slender one, fought together. In public they play master and servant; in private, and on solo missions, they treat each other as equals, two people bonded over being stuffed into roles assigned at birth.</p>

<h3>Jazz</h3>
<p>Freakishly huge and strong from the day he sprouted, which meant the military owned him even more completely than it owns every Pomen. Purple-skinned, of few words, he almost always answers rather than initiates. He is rebellious in the only ways available to him: flouting the dress code — nobody tells a man that size no — and quietly sabotaging the Empire’s attempts to breed more of him. “Jazz is like the Elden of his time in terms of unparalleled strength.” Surprisingly nimble for his size, but a big target: his style is to tank what he cannot dodge.</p>

<h3>Champlain</h3>
<p>The narcissist knight: a nimble, image-obsessed fencer from one of the Empire’s rare true lineages, coping with his conscription by pretending it is a fairy tale in which he is the hero. He is a deliberate flanderized mirror of Liz — nepotism, vanity, chivalry as armor — and his family pressures deliberately parallel Lulu’s. Meeting Strawheart in the field rattles him more than any defeat.</p>

<h3>Fate — unresolved</h3>
<p>The creators agree these two darken the story; after Jazz and Champlain, Arkan Black starts whispering in Ronnie’s ear. What is still contested is how they end: one plan has a captain’s death at Pomeroy hands — Jazz — as the loss that justifies deploying Envy, with Champlain punished for surviving; the counter-proposal has both die to an Elite instead, proving where the real monsters sit. A softer exile to a distant, grateful world has also been floated. The wiki records all three; the comic will pick one.</p>`,
    },
    {
      id: 'wk-arkan-black',
      slug: 'arkan-black',
      ...
      image: '',
      published: true,
      body: `<blockquote><p>“Your prison’s not of iron, but one of flesh and bone / And the blood that runs inside it, may no longer be your own / Let go of the hope that blinds you on an endless, deathless sea / Let mine be the voice to guide you / Set a course for eternity.”</p></blockquote>
...
<p>Cameo has spent so long in the metaphorical guts of Ambrosia and Cosmic that he knows exactly what his gods can do — so when the girls destroy Cosmic, a thing he regarded as a god of death, he does the arithmetic and goes neutral. Too proud to help the Pomeroys, too smart to stand against them, he forces a call through the ICA to distract Jonagold, beams Earth a prerecorded truce offer, and trades the Empire’s entire weapons program for an escape: the girls help his engineers flee, and Malus Robotica’s planetary teleportation array moves the whole world into Earth’s solar system — forcing Jonagold and Ambrosia to make the journey to Earth in person.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p>The <strong>Elites</strong> are Ambrosia’s innermost circle: four masked guardians who serve at her side, speak with her voice, and believe — truly believe — that what they do is right. “The kind of evil that doesn’t realize it’s evil, is the worst kind of evil there is” is their design creed. They interact with almost nobody below them; only a handful of captains — Jonagold, Red Delicious, and above all Arkan Black — ever hear from them.</p>

<h3>What they are</h3>
<p>Uniquely among modern Pomens, the Elites are <strong>Pomeroys</strong> — relics of the benevolent era when their species could still hold fruit power, kept and twisted in Ambrosia’s service. Their planned fruits form an opposite spectrum of virtues to the girls’ own: a team built, like the dark mirrors of older magical-girl stories, specifically to counter and kill them.</p>

<h3>Design</h3>
<p>Cybernetically altered toward something like warrior ants — extra limbs, and horns that are actually antennae through which Ambrosia asserts influence directly, a queen’s pheromones made mechanical. The imagery is deliberate: they are no longer apples, no longer really Pomens; they have become scavengers of their own species. Clown and classical-statue imagery is reserved for them alone, and their proposed emblem is the skull-variant of the Pomen military ensign.</p>

<h3>Deeds</h3>
<p>The Elites crushed the rebellion of Pome’s four greatest warriors — whose fused remains became Cosmic. An Elite kills Arkan Black for telling Ronnie the truth. In the finale the team fights them high in the Orchard’s rafters beside the green mind-tanks, while Ronnie falls toward the voice underneath everything.</p>`,
    },
    {
      id: 'wk-wolfgang',
      slug: 'wolfgang-manco',
      ...
      image: '',
      published: true,
      body: `<p><strong>Wolfgang Manco</strong> is a Pomeroy gunslinger in poncho and spurs, briefly employed as Sterling’s hired muscle — until Sterling broke their agreement and Wolfgang walked. His transformation barely changes him: a traditional cowboy becomes a rodeo-flair cowboy, and in place of a visor his power conjures a bandana over the lower half of his face. Because all Pomeroys can see through each other’s identity cloaks, he knows every one of the girls’ faces — and chooses not to tell anyone.</p>
...
<p>His ability is generosity weaponised: he gives his opponent stat buffs, which in turn increase his own. His style is to feel an opponent out while taunting them like a bull, then gift them the buff they cannot handle — firepower to a ship that then loses its mobility and sinks, speed to a giant who loses all accuracy. A balanced jack-of-all-trades who masters one aspect at a time by buffing himself, he is countered only by fighters as balanced and unpredictable as he is. His luchador mask means he is the one Pomeroy who never has to protect his identity.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Pittscoke</strong> is one of Repoplica’s younger cities, founded in the cold northeast where far-north chill collides with heat from the region’s steam vents — producing the thick permanent fog that is the city’s signature. Most buildings stop at two or three floors; any higher and the windows show nothing but grey. A day when the sun is visible through the fog counts as a scorcher. Seen from above, the city is shaped like a bottlecap.</p>
...
<p>Lulu Ranger has been a regular since childhood — the Blueberry Smoothie Girl, taking her post-game recovery shake at the bar. One morning, thanks to a scrambled farm inventory and Desmond’s blender, that shake contained something extra. Carelessness, not fate: the café is where the second magical girl was made, and nobody in the building noticed.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><strong>Pome</strong> was the Pomen homeworld: multicolored grass, a pastel-yellow sky with grey clouds, and a blue dwarf sun that set in greens. It is dead now — ecosystem and biosphere gone, no weather, a degraded atmosphere over an abandoned surface.</p>
...
<h3>Vegetables</h3>
<p>Vegetables are the system’s deliberate mystery: they do nothing for humans and grant Pomens temporary, random mutations. Nobody explains this. Lingon has looked into it and reports, contentedly, that it makes no sense.</p>`,
    },
    {
      id: 'wk-pomeroys',
      slug: 'pomeroys',
...
<h3>Power Blends</h3>
<p>Team-up attacks that combine two bearers’ powers into something neither owns alone — rare, spectacular, and saved for the moments that earn them.</p>`,
    },
    {
      id: 'wk-pomens',
      slug: 'pomens',
...
<p>Modern Pomens believe their species was always a cruel conqueror; almost no history of Mother’s peaceful era survives. They cannot hold fruit power — the fruits reject a culture that only takes — and they worship, fear, and pray <em>away</em> the attention of the machine that rules them. Many defect the moment it feels survivable; Pomen refugees on Earth become one of the story’s late arcs, with Qwiwi as their ambassador. A hidden tribe of spiritually intact Pomens, descended from those who fled Mother’s fall, is planned to enter the story from the margins.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p>The <strong>Fruit Poppers</strong> — the title’s “Fruit ♥ Pop” — are the story’s magical-girl team. The name is the public’s fault: the first time all five were seen fighting together, defending the O’Malleys’ shop, somebody asked what they even were — “some kind of Fruit Pop?” — and it stuck.</p>
...
<p>They are, for all their mess, unequivocally the good guys — morally dubious weirdos and absolutely good people.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p>The story’s monsters are mostly the science division’s accidents, and later Gala and Smith’s weapons program. The recipe was discovered by mistake — over-aggressive formulas plus tampered data — and refined into a production line under Red Delicious.</p>

<h3>The named ones</h3>
<ul>
...
<h3>Naming note</h3>
<p>Ronnie names the monsters after old comics and movies she’s seen, and thinks she is being clever. No one ever gets the reference.</p>`,
    },
    {
      id: 'wk-the-world',
...
<h3>The thematic loop</h3>
<p>The hostile climate isolates cultures — and the story’s heroes literally reconnect the world. Ronnie’s star flowers absorb carbon and stabilize the air wherever her dreams leak; as the girls travel, the world knits together behind them, which is the theme of the whole comic played out in weather.</p>`,
    },
    {
      id: 'wk-themes',
...
<p>Ronnie’s thesis — why people love sincere work even when it is “bad” — is the comic talking about itself. Fruit Pop wears its pulp openly: chapter-opening dream sequences in vintage halftone, monsters named after old comics, a hero who shouts “Starburst Finger” and regrets it forever. Sincerity is the armor; the story is exactly what it says it is.</p>`,
    },
    {
      ...
      image: '',
      published: true,
      body: `<p><em>This entry summarises the creators’ working plan for the full story. It is all spoilers, and all subject to change.</em></p>

<h3>Season One — Pittscoke</h3>
